  ...
  try {
    ...
    const updatedProduct = await prisma.product.update({
      ...
      data: {
        ...
        projectPrice: parseFloat(body.projectPrice) !== undefined ? parseFloat(body.projectPrice) : undefined,
        specialPrice: parseFloat(body.specialPrice) !== undefined ? parseFloat(body.specialPrice) : undefined,
