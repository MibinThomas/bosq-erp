          ...
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              <h1 className="text-xl sm:text-2xl font-bold tracking-tight text-foreground">
                {isRevision ? "Revise BOQ" : isEdit ? "Update BOQ" : "Edit BOQ Details"}
              </h1>
                                ...
                                <div className="flex flex-wrap items-center gap-2 w-full xl:w-auto shrink-0 mt-2 xl:mt-0">
                                  {isManagerOrAdmin && (
                                    <Button
                                      ...
                                      className="border-blue-500/30 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-950/30 h-9 text-xs font-medium px-3 flex items-center gap-1.5 cursor-pointer shadow-2xs"
                                    >
